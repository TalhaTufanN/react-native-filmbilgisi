  ...
  return (
    <SafeAreaView className="bg-neutral-900 flex-1">
        <View className="flex-row items-center bırder border-neutral-500 bg-neutral-900 py-2">
            <View className="ml-2 mr-2 flex-row items-center bg-neutral-800 px-1 py-1 rounded-full">
                ...
                <TextInput 
                    ...
                    className="flex-1"
                    onSubmitEditing={()=>console.log("Arama yapıldı")}
                />
        ...
        <ScrollView
            ...
            className="space-y-3">
                <Text className="text-white font-semibold ml-1">Sonuçlar ({results.length})</Text>
                            ...
                            >
                                <View className="space-y-2 mb-4">
                                    ...
                                    <Text className="text-neutral-400 ml-1">
                                        {
                                        movieName.length>20? movieName.slice(0,22)+"...":movieName
                                        }
                                    </Text>
                                </View>
